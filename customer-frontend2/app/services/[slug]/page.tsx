    ...
    general: {
      ...
      faq: [
        ...
        },
        {
          ...
          answer: 'Our technician will identify any issues and provide a quote for repairs. You can choose to proceed or schedule a separate repair appointment.',
        },
      ],
    },
    chemical: {
      ...
      faq: [
        {
          ...
          answer: 'Chemical wash is recommended every 6-12 months or when regular servicing is not sufficient to remove accumulated dirt.',
        },
        {
      ...
      faq: [
        {
          ...
          answer: 'Our technician will provide a detailed report and quote for any necessary repairs. You can then decide how to proceed.',
        },
        {
      ...
      faq: [
        {
          ...
          answer: 'Yes, installation service covers the labor and setup. You can purchase the unit from us or provide your own.',
        },
        {
          question: 'What if my home needs electrical upgrades?',
          answer: 'Our technician will assess during the site inspection and provide a quote for any necessary electrical work.',
        },
      ],
    },
    'gas-topup': {
      ...
      excluded: [
        'Repair of leaks (quoted separately)',
      ...
      faq: [
        {
          ...
          answer: 'Common signs include reduced cooling, longer time to cool, or ice formation on the unit. Our technician can check the gas levels.',
        },
        {
          question: 'What if there\'s a leak?',
          answer: 'If a leak is detected, we\'ll provide a quote for repair. The gas top-up can be done after the leak is fixed.',
        },
      ],
    },
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div ref={contentRef} className="bg-white rounded-2xl shadow-lg overflow-hidden" data-animate>
            {/* Header */}
